...
public:
	...
	void DrawText(TH1* hist, Int_t state = 0, Int_t pair = 0, Float_t xMin = 0.68, Float_t yMin = 0.75, Float_t xMax = 0.9, Float_t yMax = 0.88, Int_t align = 22, Bool_t data = true);
